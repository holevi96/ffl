        ...
        function woocommerce_template_loop_product_thumbnail() {
            ...
            <?php if ( has_post_thumbnail() ) : ?>
                <div class="<?php echo esc_attr( $class ); ?>">
                    <?php $url = wp_get_attachment_url( get_post_thumbnail_id($product->id), 'full' ); ?>
					<img class='hoverproductimg' anim="<?php echo get_field('animated_gif',$product->id);?>" src="<?php echo $url ?>" />
                </div>
            <?php endif; ?>
        <?php
        }
