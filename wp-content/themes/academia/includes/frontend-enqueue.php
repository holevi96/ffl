...
if (!function_exists('g5plus_enqueue_styles')) {
	function g5plus_enqueue_styles() {
        ...
        /*collapsible css*/
        wp_enqueue_style('collapsible', G5PLUS_THEME_URL . 'assets/css/collapsible.css', array());
...
if (!function_exists('g5plus_enqueue_script')) {
	function g5plus_enqueue_script() {
        ...
        /*Jquery collapsable*/
        wp_enqueue_script('jquery.collapsable.js', G5PLUS_THEME_URL . 'assets/js/jquery.collapsable.js', array(), false, true);
	}
